...
export const CollectionsPage: React.FC = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      bgColor: "#fce8ea",
      description:
        "Classic NY cheesecake topped with fresh organic strawberries and sweet glaze.",
    },
    {
      ...
      bgColor: "#ebe3e0",
      description:
        "70% Belgian dark chocolate ganache cheesecake with chocolate biscuit crust.",
    },
    {
      id: "lemon-cheesecake",
      ...
      bgColor: "#fef7e0",
      description:
        "Meyer lemon curd layered over silky smooth cheesecake filling.",
    },
  ];
    ...
    <main className="w-full font-sans bg-[#fbf4ea] text-[#222222] overflow-hidden">
      ...
      <section className="max-w-[1280px] mx-auto px-4 md:px-12 py-16 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {(filteredItems.length > 0 ? filteredItems : menuItems).map(
            (item) => (
              <div
                key={item.id}
              ...
              >
                ...
                <div className="flex justify-between items-center pt-2 border-t border-[#f3e3d3]">
                  <span className="font-extrabold text-base text-[#801818]">
                    ${item.price}
                  </span>
                  <button
                    onClick={() => {
        ...
        <div className="bg-[#801818] text-white rounded-3xl p-8 md:p-12 relative overflow-hidden shadow-lg grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 z-10">
            <h2 className="font-display text-3xl sm:text-4xl font-extrabold leading-tight">
              Freshly crafted cheesecake in every box, made to melt in every
              bite
            </h2>
            <p className="text-xs sm:text-sm text-[#f5d5d8] leading-relaxed max-w-md">
              Freshly made with the finest ingredients and carefully packed to
              preserve quality, each box delivers a rich, satisfying taste with
              guaranteed freshness in every bite, perfect for sharing, gifting,
              or enjoying anytime you crave a delightful treat.
            </p>
        ...
        <div className="max-w-4xl mx-auto relative grid grid-cols-1 md:grid-cols-3 items-center gap-6 bg-white p-8 rounded-3xl shadow-sm border border-[#ebd8c5]">
          ...
          <div className="space-y-6 text-left">
            <div className="bg-[#fce8ea] p-4 rounded-2xl border border-[#f3c0c5]">
              <h4 className="font-extrabold text-sm text-[#801818] mb-1">
                Strawberry Fruit
              </h4>
              <p className="text-[11px] text-[#666666] leading-relaxed">
                Made with fresh strawberries, offering a natural sweetness with
                a slight tart, adding a refreshing and vibrant flavor.
              </p>
            </div>
            ...
            <div className="bg-[#fce8ea] p-4 rounded-2xl border border-[#f3c0c5]">
              ...
              <p className="text-[11px] text-[#666666] leading-relaxed">
                Rich and creamy filling crafted from high quality ingredients,
                delivering a smooth texture and indulgent flavor.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6 text-left">
            <div className="bg-[#fce8ea] p-4 rounded-2xl border border-[#f3c0c5]">
              ...
              <p className="text-[11px] text-[#666666] leading-relaxed">
                A smooth, glossy layer that brings extra fruit sweetness while
                enhancing the rich strawberry taste in every bite.
              </p>
            </div>
            ...
            <div className="bg-[#fce8ea] p-4 rounded-2xl border border-[#f3c0c5]">
              ...
              <p className="text-[11px] text-[#666666] leading-relaxed">
                A smooth, buttery base that adds a perfect texture contrast and
                complements the soft cheesecake filling.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-[1280px] mx-auto px-4 md:px-12 py-12 text-center">
        ...
        <p className="text-xs text-[#666666] mb-10 max-w-xl mx-auto">
          Every slice is made with premium ingredients and careful baking,
          delivering a rich, creamy taste with consistent quality in every bite.
        </p>
          ...
          <div className="bg-[#801818] text-white p-8 rounded-3xl shadow-md text-center space-y-4 flex flex-col justify-between">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-[#f5d5d8] leading-relaxed">
                We use only high-quality cream cheese and fine ingredients to
                create a richer taste and a finer texture.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#e08b26] text-white p-8 rounded-3xl shadow-md text-center space-y-4 flex flex-col justify-between">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-white/90 leading-relaxed">
                Each cheesecake is freshly baked every day to maintain its
                quality, softness, and signature homemade taste.
              </p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-3xl p-6 md:p-10 shadow-sm border border-[#ebd8c5] grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative">
          ...
          <div className="lg:col-span-7 space-y-4 text-left">
            ...
            <p className="text-xs text-[#666666] leading-relaxed max-w-lg">
              Explore our curated selection of cheesecakes, crafted to be shared
